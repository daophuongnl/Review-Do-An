...
{
    public class DuctLevelingProcessor1
    {
        ...
        private DuctLevelingMode1? mode;
        public DuctLevelingMode1 Mode =>this.mode??= this.GetMode();
        //

        private Duct? mainDuct1;
        public Duct MainDuct1 => this.mainDuct1 ??= this.GetMainDuct();
